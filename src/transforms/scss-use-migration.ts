...
export function transformScssUse(code: string, filename: string): TransformResult {
  ...
  const mixinPatterns: Array<{ pattern: RegExp; replacement: string | ((match: string) => string) }> = [
    // Border radius mixins
    { pattern: /@include\s+bpk-border-radius-sm\b/g, replacement: '@include bpk-mixins.bpk-border-radius-sm' },
    { pattern: /@include\s+bpk-border-radius-md\b/g, replacement: '@include bpk-mixins.bpk-border-radius-md' },
    { pattern: /@include\s+bpk-border-radius-lg\b/g, replacement: '@include bpk-mixins.bpk-border-radius-lg' },
    ...
    { pattern: /@include\s+bpk-heading-\d+\b/g, replacement: (match: string) => match.replace('@include ', '@include bpk-mixins.') },

    // RTL mixins
    { pattern: /@include\s+bpk-rtl\b/g, replacement: '@include bpk-mixins.bpk-rtl' },
    { pattern: /@include\s+bpk-margin-leading\b/g, replacement: '@include bpk-mixins.bpk-margin-leading' },
    { pattern: /@include\s+bpk-margin-trailing\b/g, replacement: '@include bpk-mixins.bpk-margin-trailing' },
    { pattern: /@include\s+bpk-padding-leading\b/g, replacement: '@include bpk-mixins.bpk-padding-leading' },
    { pattern: /@include\s+bpk-padding-trailing\b/g, replacement: '@include bpk-mixins.bpk-padding-trailing' },
  ];
